...
// void U8g2Display::clearScreen() {
//     // Implement clearing the U8g2 display
// }

// void U8g2Display::showText(const char* text) {
//     // Implement showing text on the U8g2 display
// }

void U8g2Display::displaymessage(State state, char* message1, char* message2) {
    // Implement displaying the state and messages on the U8g2 display
    // For example, use u8g2.setCursor and u8g2.println
}

void U8g2Display::u8g2_init(void) {
#ifdef ESP32
...
void U8g2Display::u8g2_prepare(void) {
...
bool U8g2Display::screenSaverCheck() {
...
#ifdef ESP32
void U8g2Display::displaymessage_esp32_task(void* activeStateParam) {
  u8g2_init();
  delay(100);
  for (;;) {
...
void U8g2Display::displaymessage_helper(State activeState, char* displaymessagetext, char* displaymessagetext2) {
  u8g2.clearBuffer();
...
void U8g2Display::showSoftwareUpdate() {
    u8g2.drawXBMP(41, 0, icon_width, general_logo_height, update_bits);
}

void U8g2Display::showScreenSaver() {
...
void U8g2Display::showMenu(char** displaymessagetext, char** displaymessagetext2) {
  image_flip = !image_flip;
  unsigned int align_right;
  const unsigned int align_right_2digits = LCDWidth - 56;
  const unsigned int align_right_3digits = LCDWidth - 56 - 12;
...
void U8g2Display::showPowerOffCountdown(char* displaymessagetext, char* displaymessagetext2) {
