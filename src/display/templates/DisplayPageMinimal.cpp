...
void DisplayPageMinimal::initViews() {
 ...
 */
void DisplayPageMinimal::printScreen(const BrewData& b, const PidData& p, const WifiData& w, const MqttData& m, const StateData& s, const MachineData& md, const ScaleData& sd) {
