...
void DisplayPageColorBase::setStateData(const BrewData& b, const PidData& p, const WifiData& w, const MqttData& m, const StateData& s, const MachineData& md, const ScaleData& sd) {
    brewData = b;
    pidData = p;
    wifiData = w;
    mqttData = m;
