 ...
 */
void DisplayPageBase::displayWaterIcon(int x, int y) {
 ...
 */
void DisplayPageBase::displayUptime(int x, int y, const char* format) {
 ...
 */
void DisplayPageBase::displayWiFiStatus(int x, int y, const WifiData& w) {
    if (w.isConnected) {
 ...
 */
void DisplayPageBase::displayMQTTStatus(int x, int y, MqttData& mqtt) {
    if (FEATURE_MQTT == 1) {
        if (mqtt.isConnected) {
 ...
 */
void DisplayPageBase::displayThermometerOutline(int x, int y, double setpoint) {
 ...
 */
void DisplayPageBase::drawTemperaturebar(int x, int y, int heightRange, double temperature) {
    int width = x + 5;
 ...
 */
void DisplayPageBase::displayTemperature(int x, int y, double temperature) {
 ...
 */
void DisplayPageBase::displayBrewtime(int x, int y, double brewtime) {
    display->setFont(FontType::fup25);
 ...
 */
void DisplayPageBase::displayProgressbar(int value, int x, int y, int width) {
 ...
 */
void DisplayPageBase::displayStatusbar(int offlineMode) {
    // For status info
 ...
 * @brief print message
 */
void DisplayPageBase::displayMessage(String text1, String text2, String text3, String text4, String text5, String text6) {
    display->clearBuffer();
 ...
 */
bool DisplayPageBase::displayShottimer() {
 ...
 */
bool DisplayPageBase::displayMachineState() {
